...
func front() {
	...
	//支付相关路由
	beego.Router("/pay/recharge", &HomeControllers.PayController{}, "get:Recharge")
	beego.Router("/pay/order", &HomeControllers.PayController{}, "post:CreateOrder")
	beego.Router("/pay/alipay/return", &HomeControllers.PayController{}, "get:AlipayReturn")
	beego.Router("/pay/alipay/notify", &HomeControllers.PayController{}, "post:AlipayNotify")
	beego.Router("/pay/wechat/qrcode", &HomeControllers.PayController{}, "get:WechatQrcode")
	beego.Router("/pay/wechat/notify", &HomeControllers.PayController{}, "post:WechatNotify")
	beego.Router("/pay/order/status", &HomeControllers.PayController{}, "get:OrderStatus")
	beego.Router("/pay/result", &HomeControllers.PayController{}, "get:Result")
...
func back() {
	...
	beego.Router("/admin/order", &AdminControllers.OrderController{}, "get:List")
	beego.Router("/admin/order/list/*", &AdminControllers.OrderController{}, "get:List")
